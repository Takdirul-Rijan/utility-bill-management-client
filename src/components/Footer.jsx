...
const Footer = () => {
  return (
    <footer
      ...
      text-gray-700 dark:text-gray-300 mt-10 transition-all duration-300"
    >
      <div className="rounded-2xl overflow-hidden py-10 px-6 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-gray-300 dark:border-gray-700 pb-8">
          <div className="text-center md:text-left">
            <h2 className="text-2xl md:text-2xl font-bold text-gray-900 dark:text-blue-400 mb-3">
              Smart
          ...
          <div className="flex flex-col items-center justify-center md:text-left">
